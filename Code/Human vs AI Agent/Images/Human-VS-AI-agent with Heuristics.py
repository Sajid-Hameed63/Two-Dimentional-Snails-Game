...
class StartGame(arcade.View):
    ...
    def on_draw(self):
        ...
        self.status = self.evaluateBoard(self.Board)
    ...
    def calculations(self, x, y):
        ...
        self.status = self.evaluateBoard(self.Board) # Evaluate Board
    ...
    def botMove(self, Next_Backend_grid_row, Next_Backend_grid_col ):
        #self.BS , Next_Backend_grid_row, Next_Backend_grid_col = self.minimax(self.Board, 0, True, MIN, MAX)
        Next_Backend_grid_row , Next_Backend_grid_col = self.heuristics(self.Board)
        print(f"Next_Backend_grid_row = {Next_Backend_grid_row} & Next_Backend_grid_col = {Next_Backend_grid_col}")
    ...
    def heuristics(self,board):
        ...
        self.x = self.Previos_Backend_grid_row_H2
        self.y = self.Previos_Backend_grid_col_H2
